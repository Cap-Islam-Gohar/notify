    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-logout">Log out a user</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="notifications">
                    <a href="#notifications">Notifications</a>
                                ...
                                <a href="#notifications-POSTapi-notifications--notification_id--read">Mark a notification as read.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="notifications-POSTapi-notifications--notification_id--unread">
                                <a href="#notifications-POSTapi-notifications--notification_id--unread">Mark a notification as unread.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="products">
                    ...
                    <ul id="tocify-header-todos" class="tocify-header">
                <li class="tocify-item level-1" data-unique="todos">
                    <a href="#todos">Todos</a>
                </li>
                                    <ul id="tocify-subheader-todos" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="todos-GETapi-todos">
                                <a href="#todos-GETapi-todos">List todos</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="todos-POSTapi-todos">
                                <a href="#todos-POSTapi-todos">Create a todo</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="todos-GETapi-todos--id-">
                                <a href="#todos-GETapi-todos--id-">Show a todo</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="todos-PUTapi-todos--id-">
                                <a href="#todos-PUTapi-todos--id-">Update a todo</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="todos-DELETEapi-todos--id-">
                                <a href="#todos-DELETEapi-todos--id-">Delete a todo</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="todos-POSTapi-todos-complete">
                                <a href="#todos-POSTapi-todos-complete">Mark a todo as completed</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user's email. Example: <code>test@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<p>The user's password. Example: <code>password</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-logout">Log out a user</h2>
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8000/api/notifications/03fafd0d-72fb-4268-b0b7-14367e3d6dd4/read';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/notifications/03fafd0d-72fb-4268-b0b7-14367e3d6dd4/read"
);
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="notification_id"                data-endpoint="POSTapi-notifications--notification_id--read"
               value="03fafd0d-72fb-4268-b0b7-14367e3d6dd4"
               data-component="url">
    <br>
<p>The ID of the notification. Example: <code>03fafd0d-72fb-4268-b0b7-14367e3d6dd4</code></p>
            </div>
                    </form>

                    <h2 id="notifications-POSTapi-notifications--notification_id--unread">Mark a notification as unread.</h2>
...
<span id="example-requests-POSTapi-notifications--notification_id--unread">
<blockquote>Example request:</blockquote>


<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8000/api/notifications/03fafd0d-72fb-4268-b0b7-14367e3d6dd4/unread';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/notifications/03fafd0d-72fb-4268-b0b7-14367e3d6dd4/unread"
);
...
<span id="example-responses-POSTapi-notifications--notification_id--unread">
</span>
<span id="execution-results-POSTapi-notifications--notification_id--unread" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-notifications--notification_id--unread"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-notifications--notification_id--unread"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-notifications--notification_id--unread" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-notifications--notification_id--unread">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-notifications--notification_id--unread" data-method="POST"
      data-path="api/notifications/{notification_id}/unread"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-notifications--notification_id--unread', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-notifications--notification_id--unread"
                    onclick="tryItOut('POSTapi-notifications--notification_id--unread');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-notifications--notification_id--unread"
                    onclick="cancelTryOut('POSTapi-notifications--notification_id--unread');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-notifications--notification_id--unread"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/notifications/{notification_id}/unread</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-notifications--notification_id--unread"
               value="Bearer YOUR_AUTH_KEY"
               data-component="header">
    <br>
<p>Example: <code>Bearer YOUR_AUTH_KEY</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-notifications--notification_id--unread"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-notifications--notification_id--unread"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="notification_id"                data-endpoint="POSTapi-notifications--notification_id--unread"
               value="03fafd0d-72fb-4268-b0b7-14367e3d6dd4"
               data-component="url">
    <br>
<p>The ID of the notification. Example: <code>03fafd0d-72fb-4268-b0b7-14367e3d6dd4</code></p>
...
<p>The ID of the product. Example: <code>1</code></p>
    ...
    <p>APIs for managing todos.</p>

                                <h2 id="todos-GETapi-todos">List todos</h2>
...
<span id="execution-results-GETapi-todos" hidden>
    ...
    <pre class="json"><code id="execution-response-content-GETapi-todos"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-todos" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-todos">
...
<form id="form-GETapi-todos" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-todos');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-todos"
                    onclick="cancelTryOut('GETapi-todos');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-todos"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-todos"
               value="Bearer YOUR_AUTH_KEY"
               data-component="header">
    <br>
<p>Example: <code>Bearer YOUR_AUTH_KEY</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-todos"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-todos"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="todos-POSTapi-todos">Create a todo</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-todos"
               value="Bearer YOUR_AUTH_KEY"
               data-component="header">
    <br>
<p>Example: <code>Bearer YOUR_AUTH_KEY</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="title"                data-endpoint="POSTapi-todos"
               value="b"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="POSTapi-todos"
               value="Eius et animi quos velit et."
               data-component="body">
    <br>
<p>Example: <code>Eius et animi quos velit et.</code></p>
                    ...
                    <h2 id="todos-GETapi-todos--id-">Show a todo</h2>
...
<span id="execution-results-GETapi-todos--id-" hidden>
    ...
    <pre class="json"><code id="execution-response-content-GETapi-todos--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-todos--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-todos--id-">
...
<form id="form-GETapi-todos--id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-todos--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-todos--id-"
                    onclick="cancelTryOut('GETapi-todos--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-todos--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-todos--id-"
               value="Bearer YOUR_AUTH_KEY"
               data-component="header">
    <br>
<p>Example: <code>Bearer YOUR_AUTH_KEY</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-todos--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-todos--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="GETapi-todos--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the todo. Example: <code>1</code></p>
                    ...
                    <h2 id="todos-PUTapi-todos--id-">Update a todo</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PUTapi-todos--id-"
               value="Bearer YOUR_AUTH_KEY"
               data-component="header">
    <br>
<p>Example: <code>Bearer YOUR_AUTH_KEY</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="PUTapi-todos--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the todo. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="title"                data-endpoint="PUTapi-todos--id-"
               value="b"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
...
<p>Example: <code>Eius et animi quos velit et.</code></p>
                    ...
                    <h2 id="todos-DELETEapi-todos--id-">Delete a todo</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="DELETEapi-todos--id-"
               value="Bearer YOUR_AUTH_KEY"
               data-component="header">
    <br>
<p>Example: <code>Bearer YOUR_AUTH_KEY</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="DELETEapi-todos--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the todo. Example: <code>1</code></p>
                    ...
                    <h2 id="todos-POSTapi-todos-complete">Mark a todo as completed</h2>
...
<span id="example-requests-POSTapi-todos-complete">
<blockquote>Example request:</blockquote>


<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8000/api/todos/complete';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/todos/complete"
);
...
<span id="example-responses-POSTapi-todos-complete">
</span>
<span id="execution-results-POSTapi-todos-complete" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-todos-complete"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-todos-complete"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-todos-complete" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-todos-complete">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-todos-complete" data-method="POST"
      data-path="api/todos/complete"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-todos-complete', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-todos-complete"
                    onclick="tryItOut('POSTapi-todos-complete');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-todos-complete"
                    onclick="cancelTryOut('POSTapi-todos-complete');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-todos-complete"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/todos/complete</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-todos-complete"
               value="Bearer YOUR_AUTH_KEY"
               data-component="header">
    <br>
<p>Example: <code>Bearer YOUR_AUTH_KEY</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-todos-complete"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-todos-complete"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
